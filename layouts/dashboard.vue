...
<template>
  <div>
    ...
    <div class="sticky top-0 z-40 flex items-center gap-x-6 bg-primary-600 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
      <button type="button" class="-m-2.5 p-2.5 text-primary-200 lg:hidden" @click="sidebarOpen = true">
